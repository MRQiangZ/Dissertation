...
clf.set_params(b_subsample = 0.8,b_colsample_bytree = 0.95)
"""
param_test7 = {
...
"""
clf.set_params(reg_alpha = 14,reg_lambda = 18)
...
#joblib.dump(gsearch,'./model/param_test9.m')
...
print(time_end.strftime('%Y-%m-%d %H:%M:%S'))
print('*'*50)
#joblib.dump(clf,'./model/xgboost_15.m')

y_pred = clf.predict(X_test_15.values)
rmse = RMSE(y_pred,y_test.values.T)
print('RMSE:')
print(rmse)
print('*'*50)
