...
X_train_16 = pd.read_csv('./data/all_X_train_normalized.csv')
X_test_16 = pd.read_csv('./data/all_X_test_normalized.csv')
...
"""
clf.set_params(reg_alpha = 12,reg_lambda = 18)
...
print(time_end.strftime('%Y-%m-%d %H:%M:%S'))
print('*'*50)
joblib.dump(clf,'./model/xgboost_all.m')
