...
X_train_16 = pd.read_csv('./data/time_x_train_normalised.csv')
X_test_16 = pd.read_csv('./data/time_x_test_normalised.csv')
...
y_train = pd.read_csv('./data/time_y_train.csv')
y_test = pd.read_csv('./data/time_y_test.csv')
