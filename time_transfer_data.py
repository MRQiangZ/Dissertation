...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul  3 22:19:40 2019
...
keys = ['jakobshavn11', 'jakobshavn12', 'jakobshavn13', 'jakobshavn14', 'jakobshavn15', 
        ...
        'southeast15',  'storstrommen11', 'storstrommen12', 'storstrommen13', 
        'storstrommen14', 'storstrommen15']
i = 0
data = []
...
keys_test = ['jakobshavn16','southeast16','storstrommen16']
j = 0
test_data = []
...
x_train_normlized.to_csv ("./data/time_x_train_normalised.csv" , encoding = "utf-8" , index = False)
x_test_normalized.to_csv ("./data/time_x_test_normalised.csv" , encoding = "utf-8" , index = False)
pd.DataFrame(y_train).to_csv ("./data/time_y_train.csv" , encoding = "utf-8" , index = False)
pd.DataFrame(y_test).to_csv ("./data/time_y_test.csv" , encoding = "utf-8" , index = False)
